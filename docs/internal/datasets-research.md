...
Этот файл является репозиторной версией RU-отчета `retail_shelf_robot_datasets_research_ru.md`: исходное исследование сохранено здесь и дополнено разделом 12 с OCR/barcode-источниками для хакатонного пайплайна.
...
[`./briefing.md`](./briefing.md) §5). Оценки в той же
...
Cyrillic-OCR, дополняет синтетику Tier 0 из [`datasets.md`](../data/datasets.md).
...
[`datasets.md`](../data/datasets.md) — здесь канонический репозиторий и метрики.
